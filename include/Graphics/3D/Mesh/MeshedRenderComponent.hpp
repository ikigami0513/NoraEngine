#ifndef MESHED_RENDER_COMPONENT_HPP
#define MESHED_RENDER_COMPONENT_HPP
...
class MeshedRenderComponent : public RenderComponent {
    public:
        virtual ~MeshedRenderComponent() = default;
